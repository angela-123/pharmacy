...
<html>
    ...
    <body style=" background:  #49afcd;">
        ...
        <?php 
        $fed = "select SUM(qtysold * unitprice) As Credit,SUM(custpmt) As Payment,sum(disc * 0.01 * qtysold * unitprice)+ sum(naira) as discount from dailies where customer = '$supname' and customer !=''";
        $dap = mysql_query($fed);
        ...
        <?php 
        $jilo = "select ddate as date,productcode as name, qtysold * unitprice As extended,disc * 0.01 * unitprice * qtysold+naira as discount,naira as discinnaira,custpmt as payment from dailies where customer = '$supname' and qtysold + disc + custpmt+naira >0 and customer!=''";
