...
<html lang="en">
    ...
    <?php
         ...
         $gaf = "select productcode,sum(qtysold)as qty,salestype,disc,sum(qtysold * unitprice) As Amount from dailies where  ddate = '$date' And qtysold > 0 and cashier = '$cashier' group by productcode";
         $zam = "select SUM(qtysold * unitprice) As Total from dailies where ddate = '$date' and cashier = '$cashier' ";
