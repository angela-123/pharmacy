            ...
            {  
              ...
              var vat = $("#vat").val();
                ...
                $.ajax({
                    type:"POST",
                    url:"pharm.php",
                   data:"tdate="+tdate+"&code="+code+"&qty="+qty+"&recno="+recno+"&cashier="+cashier+"&disc="+disc+"&naira="+naira+"&stype="+stype+"&cname="+cname+"&vat="+vat,
            ...
            $("#kode").click(function(){
                    ...
                    $("#pd").click(function(){
                        ...
                        $.ajax({
                            ...
                            type:"post",
                            url:"cat.php",
                            data:"cname="+cname+"&od="+od+"&date="+date,
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="number" name="od" id="od" placeholder="old debt"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="button" value="Old Debt" id="pd"></td>
                    </tr>
                </tbody>
            </table>
            <div id="zulio"></div>
