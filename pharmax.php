...
$mysales = mysql_fetch_assoc($tsales);
        ...
        $buns = mysql_num_fields($res);
                ...
                echo '<ul align = "left">';
                echo '<li class = "lag">DUFLUX PHARMACY</li>';
                echo '<li class ="lag">Sariki Yaki House,Guzape</li>';
                
                   
                //echo '<li class ="lag">Royal Indomie Road</li>';
                echo '<li class ="lag">Abuja,F.c.t</li>';
                //echo '<nobsp>';
                //echo '<li class ="lag">NassarawaState</li>';
                echo '<li class ="lag">08037881619,07014100104</li>';
