...
<html>
    <head>
        <meta charset="UTF-8">
        <title>PHARMACY MANAGEMENT SYSTEM,LOGGED ON:  <title>
  ...
  <p id="splash">Welcome:<?php echo $_SESSION['username']; ?></p>
		...
		<li><a href="#">Start</a>
			<ul>
                            ...
                            <li><a href="baritems.php">Preview Drugs</a></li>
                            <li><a href="litems.php"><nobr>Update Drugs Info</nobr></a></li>
			...
			<li><a href = "#">Guests</a>
			<ul>
                            <li><a href="mypayments.php"><nobr>Guest Payments</nobr></a></li>
                            <li><a href = "ledger.php"><nobr>Generate Bill</nobr></a></li>
                            <li><a href="#"><nobr>Guests Checkout</nobr></a></li>
			...
			<ul>
			<li><a href = "dsales.php">Daily Sales</a></li>
			...
			<li><a href = "nnstock.php">Stock Report</a></li>
			</ul>
