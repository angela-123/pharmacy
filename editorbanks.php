...
<html>
    ...
    <body>
        <script>
            ...
            $(document).ready(function(){
                ...
                $("#bta").click(function(){
                    ...
                    $.ajax({
                        type:"post",
                        url:"editoffbanks.php",
                        data:"date="+date+"&bank="+bank+"&did="+did,
       ...
       // echo 'HELLO';
        ...
        $sach = "select did, ddate,banks,cashrecs from drecs where ddate = '$date'  and banks > 0";
        ...
        ?>
            ...
            <tr><td>Bank Lodgement</td>
                <td><input type="number" id="bank" class="form-control" value="<?php echo $row['banks']; ?>"></td>
            </tr>
